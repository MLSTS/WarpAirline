...
<?php
			...
			{	$homepage = "../../index.php";
				...
				if ($_SESSION['s_user_name'] != "MatitL" || $_SESSION['s_user_name'] != "PintusornS" ||$_SESSION['s_user_name'] != "WasuponP" ||$_SESSION['s_user_name'] != "NatthanichaS"|| $_SESSION['s_user_name'] != "TrongtrongV" || $_SESSION['s_member'] != "E")
				{
					$homepage = "../../index.php";
    ...
    <div class="row"> 
        <div class="col-md-3 "> 
            <div class="list-group "> 
                ...
                <a href="WA_BE_Countries.php" class="list-group-item list-group-item-action active" style="background-color: #0a1b4f;">Countries</a> 
        ...
        <div class="col-md-9"> 
            <div class="card"> 
                <div class="card-body"> 
                    <div class="row"> 
                        <div class="col-md-12"> 
                            <h4>Countries of Warp Airline</h4> 
                            <hr> 
                      </div>                         
                    </div>                     
                    <div class="row"> 
